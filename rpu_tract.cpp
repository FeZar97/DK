...
void RPU_tract::print_tract_info()
{
    ...
    //print_message(MEDIUM, tract_info);
}
...
void RPU_tract::set_central_freq(unsigned int new_central_freq)
{
...
unsigned int RPU_tract::get_central_freq()
{
    return central_freq;
}
...
void RPU_tract::set_hf_att_idx(short new_hf_att_idx)
{
...
unsigned short RPU_tract::get_hf_att_idx()
{
    return hf_att_idx;
}

// изменение значения аттенюатора ПЧ
void RPU_tract::set_if_att_idx(short new_if_att_idx)
{
...
unsigned short RPU_tract::get_if_att_idx()
{
    return if_att_idx;
}

// изменение значения ширины полосы ПЧ
void RPU_tract::set_if_band_idx(short new_if_band_idx)
{
...
unsigned short RPU_tract::get_if_band_idx()
{
    return if_band_idx;
}
